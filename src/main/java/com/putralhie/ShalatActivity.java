...
public class ShalatActivity extends AppCompatActivity {
    ...
    private void loadKota(){
        try {
            String api = "/kota";
            ClientAsyncTaskShalat task = new ClientAsyncTaskShalat(this, api, new ClientAsyncTaskShalat.OnPostExecuteListener() {
                @Override
    ...
    private void loadJadwal(int id){
        try {
            ...
            ClientAsyncTaskShalat task = new ClientAsyncTaskShalat(this, api_url, new ClientAsyncTaskShalat.OnPostExecuteListener() {
                @Override
                public void onPostExecute(String result) {
