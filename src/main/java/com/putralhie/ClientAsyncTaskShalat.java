...
public class ClientAsyncTaskShalat extends AsyncTask<Void, Void, String> {
    ...
    public ClientAsyncTaskShalat(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
